...
return [
    ...
    */
    ...
    $str => ':attribute لازماً کسی رینج پر مشتمل ہو۔',
    'before'               => ':attribute لازماً :date سے پہلے کی کوئی تاریخ ہو۔',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => ':attribute لازماً :min اور :max کے درمیان ہو۔',
        'file'    => ':attribute لازماً :min اور :max کلو بائٹس کے درمیان ہو۔',
        $str2 => ':attribute لازماً :min اور :max کریکٹرز کے درمیان ہو۔',
        $str => ':attribute لازماً :min اور :max آئٹمز کے درمیان ہو۔',
    ],
    ...
    'max'                  => [
        $str1 => ':attribute کو :max سے بڑا نہیں ہونا چاہیے۔',
        'file'    => ':attribute کو :max کلو بائٹس سے زیادہ نہیں ہونا چاہیے۔',
        $str2 => ':attribute کو :max کریکٹرز سے زیادہ نہیں ہونا چاہیے۔',
        $str => ':attribute میں :max سے زیادہ آئٹمز نہیں ہو سکتیں۔',
    ],
    'mimes'                => ':attribute لازماً :type :values قسم کی فائل ہو۔',
    'mimetypes'            => 'The :attribute must be a file of type: :values.',
    'min'                  => [
        $str1 => ':attribute لازماً کم از کم :min ہو۔',
        'file'    => ':attribute لازماً کم از کم :min کلو بائٹس کی ہو۔',
        $str2 => ':attribute لازماً کم از کم :min کریکٹرز طویل ہو۔',
        $str => ':attribute میں لازماً کم از کم :min آئٹمز ہوں۔',
    ],
    'not_in'               => 'منتخب :attribute قابلِ قبول نہیں ہے۔',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':attribute لازماً کوئی عدد ہو۔',
    ...
    'size'                 => [
        $str1 => ':attribute لازماً :size ہوں۔',
        'file'    => ':attribute کا سائز لازماً :size کلو بائٹس ہو۔',
        $str2 => ':attribute لازماً :size کریکٹرز پر مشتمل ہو۔',
        $str => ':attribute میں لازماً :size آئٹمز شامل ہوں۔',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':attribute لازماً کوئی سٹرنگ ہو۔',
