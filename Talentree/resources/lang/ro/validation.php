...
$str1 = 'numeric';
$str2 = 'string';
$str3 = 'Câmpul :attribute selectat nu este valid.';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    $str => 'Câmpul :attribute trebuie să fie un array.',
    ...
    'between'              => [
        $str1 => 'Câmpul :attribute trebuie să fie între :min și :max.',
        'file'    => 'Câmpul :attribute trebuie să fie între :min și :max kiloocteți.',
        $str2 => 'Câmpul :attribute trebuie să fie între :min și :max caractere.',
        $str => 'Câmpul :attribute trebuie să aibă între :min și :max elemente.',
    ],
    ...
    'gt'                   => [
        $str1 => 'Câmpul :attribute trebuie să fie mai mare de :value.',
        'file'    => 'Câmpul :attribute trebuie să fie mai mare de :value kilobyți.',
        $str2 => 'Câmpul :attribute trebuie să fie mai mare de :value caractere.',
        $str => 'Câmpul :attribute trebuie să aibă mai multe de :value elemente.',
    ],
    'gte'                  => [
        $str1 => 'Câmpul :attribute trebuie să fie mai mare sau egal cu :value.',
        'file'    => 'Câmpul :attribute trebuie să fie mai mare sau egal cu :value kilobyți.',
        $str2 => 'Câmpul :attribute trebuie să fie mai mare sau egal cu :value caractere.',
        $str => 'Câmpul :attribute trebuie să aibă :value elemente sau mai multe.',
    ],
    ...
    'lt'                   => [
        $str1 => 'Câmpul :attribute trebuie să fie mai mic de :value.',
        'file'    => 'Câmpul :attribute trebuie să fie mai mic de :value kilobyți.',
        $str2 => 'Câmpul :attribute trebuie să fie mai mic de :value caractere.',
        $str => 'Câmpul :attribute trebuie să aibă mai puțin de :value elemente.',
    ],
    'lte'                  => [
        $str1 => 'Câmpul :attribute trebuie să fie mai mic sau egal cu :value.',
        'file'    => 'Câmpul :attribute trebuie să fie mai mic sau egal cu :value kilobyți.',
        $str2 => 'Câmpul :attribute trebuie să fie mai mic sau egal cu :value caractere.',
        $str => 'Câmpul :attribute trebuie să aibă :value elemente sau mai puține.',
    ],
    'max'                  => [
        $str1 => 'Câmpul :attribute nu poate fi mai mare de :max.',
        'file'    => 'Câmpul :attribute nu poate avea mai mult de :max kiloocteți.',
        $str2 => 'Câmpul :attribute nu poate avea mai mult de :max caractere.',
        $str => 'Câmpul :attribute nu poate avea mai mult de :max elemente.',
    ],
    ...
    'min'                  => [
        $str1 => 'Câmpul :attribute nu poate fi mai mic de :min.',
        'file'    => 'Câmpul :attribute trebuie să aibă cel puțin :min kiloocteți.',
        $str2 => 'Câmpul :attribute trebuie să aibă cel puțin :min caractere.',
        $str => 'Câmpul :attribute trebuie să aibă cel puțin :min elemente.',
    ],
    'not_in'               => $str3,
    'not_regex'            => 'Câmpul :attribute nu are un format valid.',
    $str1 => 'Câmpul :attribute trebuie să fie un număr.',
    ...
    'size'                 => [
        $str1 => 'Câmpul :attribute trebuie să fie :size.',
        'file'    => 'Câmpul :attribute trebuie să aibă :size kiloocteți.',
        $str2 => 'Câmpul :attribute trebuie să aibă :size caractere.',
        $str => 'Câmpul :attribute trebuie să aibă :size elemente.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'Câmpul :attribute trebuie să fie string.',
