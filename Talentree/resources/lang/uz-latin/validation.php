...
return [
    ...
    */
    ...
    $str => ':Attribute maydoni qator (array) bo‘lishi kerak.',
    ...
    'between'              => [
        $str1 => ':Attribute maydonining qiymati :min va :max orasida bo‘lishi kerak.',
        'file'    => ':Attribute maydonidagi faylning hajmi :min va :max kilobayt orasida bo‘lishi kerak.',
        $str2 => ':Attribute maydonidagi belgilar soni :min va :max orasida bo‘lishi kerak.',
        $str => ':Attribute maydonida elementlar soni :min va :max orasida bo‘lishi kerak.',
    ],
    ...
    'max'                  => [
        $str1 => ':Attribute maydoni qiymati :max dan oshmasligi kerak.',
        'file'    => ':Attribute maydonidagi faylning hajmi :max kilobaytdan oshmasligi kerak.',
        $str2 => ':Attribute maydonidagi belgilar soni :max tadan oshmasligi kerak.',
        $str => ':Attribute maydonidagi elmentlar soni :max tadan oshmasligi kerak.',
    ],
    ...
    'min'                  => [
        $str1 => ':Attribute maydoni qiymati :min dan kam bo‘lmasligi kerak.',
        'file'    => ':Attribute maydonidagi faylning hajmi :min kilobaytdan kam bo‘lmasligi kerak.',
        $str2 => ':Attribute maydonidagi belgilar soni :min tadan kam bo‘lmasligi kerak.',
        $str => ':Attribute maydonidagi elmentlar soni :min tadan kam bo‘lmasligi kerak.',
    ],
    'not_in'               => ':Attribute maydoni uchun tanlangan qiymat xato.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':Attribute maydoni son bo‘lishi kerak.',
    ...
    'size'                 => [
        $str1 => ':Attribute maydoni qiymati :size ga teng bo‘lishi kerak.',
        'file'    => ':Attribute maydonidagi faylning hajmi :size kilobaytga teng bo‘lishi kerak.',
        $str2 => ':Attribute maydonidagi belgilar soni :size ga teng bo‘lishi kerak.',
        $str => ':Attribute maydonidagi elmentlar soni :size ga teng bo‘lishi kerak.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':Attribute maydoni qator (string) bo‘lishi kerak.',
