...
$str1 = 'numeric';
$str2 = 'string';
$str3 = 'Nid yw :attribute yn ddilys.';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    $str => 'Rhaid i :attribute fod yn array.',
    'before'               => 'Rhaid i :attribute fod yn ddyddiad sydd cyn :date.',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => 'Rhaid i :attribute fod rhwng :min a :max.',
        'file'    => 'Rhaid i :attribute fod rhwng :min a :max kilobytes.',
        $str2 => 'Rhaid i :attribute fod rhwng :min a :max nodyn.',
        $str => 'Rhaid i :attribute fod rhwng :min a :max eitem.',
    ],
    ...
    'max'                  => [
        $str1 => 'Ni chai :attribute fod yn fwy na :max.',
        'file'    => 'Ni chai :attribute fod yn fwy na :max kilobytes.',
        $str2 => 'Ni chai :attribute fod yn fwy na :max nodyn.',
        $str => 'Ni chai :attribute fod yn fwy na :max eitem.',
    ],
    'mimes'                => "Rhaid i :attribute fod yn ffeil o'r math: :values.",
    'mimetypes'            => "Rhaid i :attribute fod yn ffeil o'r math: :values.",
    'min'                  => [
        $str1 => 'Rhaid i :attribute fod o leiaf :min.',
        'file'    => 'Rhaid i :attribute fod o leiaf :min kilobytes.',
        $str2 => 'Rhaid i :attribute fod o leiaf :min nodyn.',
        $str => 'Rhaid i :attribute fod o leiaf :min eitem.',
    ],
    'not_in'               => $str3,
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => 'Rhaid i :attribute fod yn rif.',
    ...
    'size'                 => [
        $str1 => 'Rhaid i :attribute fod yn :size.',
        'file'    => 'Rhaid i :attribute fod yn :size kilobytes.',
        $str2 => 'Rhaid i :attribute fod yn :size nodyn.',
        $str => 'Rhaid i :attribute fod yn :size eitem.',
    ],
