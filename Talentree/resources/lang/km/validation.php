...
return [
    ...
    */
    ...
    $str => ':attribute ត្រូវតែជា អារេ។',
    'before'               => ':attribute ត្រូវតែមានកាលបរិច្ឆេទមុន :date។',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => ':attribute ត្រូវតែមានរវាង :min និង :max។',
        'file'    => ':attribute ត្រូវតែមានរវាង :min និង :max គីឡូបៃ។',
        $str2 => ':attribute ត្រូវតែមានរវាង :min និង :max តួអក្សរ។',
        $str => ':attribute ត្រូវតែមានធាតុរវាង :min និង :max។',
    ],
    ...
    'max'                  => [
        $str1 => ':attribute មិនត្រូវធំជាង :max។',
        'file'    => ':attribute មិនត្រូវធំជាង :max គីឡូបៃ។',
        $str2 => ':attribute មិនត្រូវធំជាង :max តួអក្សរ។',
        $str => ':attribute មិនត្រូវច្រើនជាងធាតុនេះ :max។',
    ],
    'mimes'                => ':attribute ត្រូវតែជាប្រភេទឯកសារ type: :values នេះ។',
    'mimetypes'            => ':attribute ត្រូវតែជាប្រភេទឯកសារ type: :values នេះ។',
    'min'                  => [
        $str1 => ':attribute ត្រូវតែតូចជាង :min។',
        'file'    => ':attribute ត្រូវតៃតួចជាង :min គីឡូបៃ។',
        $str2 => ':attribute ត្រូវតែតូចជាង :min តួអក្សរ។',
        $str => ':attribute ត្រូវតែតិចជាងធាតុនេះ :min។',
    ],
    'not_in'               => 'ការជ្រើសរើស :attribute គឺត្រឹមត្រូវ។',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':attribute ត្រូវតែជាលេខ។',
    ...
    'size'                 => [
        $str1 => ':attribute ត្រូវតែ :size។',
        'file'    => ':attribute ត្រូវតែ :size គីឡូបៃ។',
        $str2 => ':attribute ត្រូវតែ :size តួអក្សរ។',
        $str => ':attribute ត្រូវតែមានទំហំ :size។',
    ],
