...
return [
    ...
    */
    ...
    $str => 'Polje :attribute mora sadržati određen broj stavki.',
    'before'               => 'Polje :attribute mora biti datum prije :date.',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => 'Polje :attribute mora biti između :min - :max.',
        'file'    => 'Fajl :attribute mora biti između :min - :max kilobajta.',
        $str2 => 'Polje :attribute mora sadržati između :min - :max karaktera.',
        $str => 'Polje :attribute mora sadržati između :min - :max stavki.',
    ],
    ...
    $str3 => 'Format polja :attribute nije validan.',
    ...
    'max'                  => [
        $str1 => 'Polje :attribute mora biti manje od :max.',
        'file'    => 'Polje :attribute mora biti manje od :max kilobajta.',
        $str2 => 'Polje :attribute mora sadržati manje od :max karaktera.',
        $str => 'Polje :attribute ne smije da image više od :max stavki.',
    ],
    'mimes'                => 'Polje :attribute mora biti fajl tipa: :values.',
    'mimetypes'            => 'Polje :attribute mora biti fajl tipa: :values.',
    'min'                  => [
        $str1 => 'Polje :attribute mora biti najmanje :min.',
        'file'    => 'Fajl :attribute mora biti najmanje :min kilobajta.',
        $str2 => 'Polje :attribute mora sadržati najmanje :min karaktera.',
        $str => 'Polje :attribute mora sadrzati najmanje :min stavke.',
    ],
    'not_in'               => 'Odabrani element polja :attribute nije validan.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => 'Polje :attribute mora biti broj.',
    ...
    'size'                 => [
        $str1 => 'Polje :attribute mora biti :size.',
        'file'    => 'Fajl :attribute mora biti :size kilobajta.',
        $str2 => 'Polje :attribute mora biti :size karaktera.',
        $str => 'Polje :attribute mora sadržati :size stavki.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'Polje :attribute mora biti string.',
