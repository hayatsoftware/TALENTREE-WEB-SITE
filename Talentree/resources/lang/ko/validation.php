...
return [
    ...
    */
    ...
    $str => ':attribute은(는) 배열이어야 합니다.',
    'before'               => ':attribute은(는) :date 이전 날짜여야 합니다.',
    'before_or_equal'      => ':attribute은(는) :date 이전 날짜이거나 같은 날짜여야 합니다.',
    'between'              => [
        $str1 => ':attribute은(는) :min에서 :max 사이여야 합니다.',
        'file'    => ':attribute은(는) :min에서 :max 킬로바이트 사이여야 합니다.',
        $str2 => ':attribute은(는) :min에서 :max 문자 사이여야 합니다.',
        $str => ':attribute은(는) :min에서 :max 개의 항목이 있어야 합니다.',
    ],
    ...
    'gt'                   => [
        $str1 => ':attribute의 값은 :value보다 커야 합니다.',
        'file'    => ':attribute의 용량은 :value킬로바이트보다 커야 합니다.',
        $str2 => ':attribute의 길이는 :value보다 길어야 합니다.',
        $str => ':attribute의 항목수는 :value개 보다 많아야 합니다.',
    ],
    'gte'                  => [
        $str1 => ':attribute의 값은 :value보다 같거나 커야 합니다.',
        'file'    => ':attribute의 용량은 :value킬로바이트보다 같거나 커야 합니다.',
        $str2 => ':attribute의 길이는 :value보다 같거나 길어야 합니다.',
        $str => ':attribute의 항목수는 :value개 보다 같거나 많아야 합니다.',
    ],
    ...
    'lt'                   => [
        $str1 => ':attribute의 값은 :value보다 작아야 합니다.',
        'file'    => ':attribute의 용량은 :value킬로바이트보다 작아야 합니다.',
        $str2 => ':attribute의 길이는 :value보다 짧아야 합니다.',
        $str => ':attribute의 항목수는 :value개 보다 작아야 합니다.',
    ],
    'lte'                  => [
        $str1 => ':attribute의 값은 :value보다 같거나 작아야 합니다.',
        'file'    => ':attribute의 용량은 :value킬로바이트보다 같거나 작아야 합니다.',
        $str2 => ':attribute의 길이는 :value보다 같거나 짧아야 합니다.',
        $str => ':attribute의 항목수는 :value개 보다 같거나 작아야 합니다.',
    ],
    'max'                  => [
        $str1 => ':attribute은(는) :max보다 클 수 없습니다.',
        'file'    => ':attribute은(는) :max킬로바이트보다 클 수 없습니다.',
        $str2 => ':attribute은(는) :max자보다 클 수 없습니다.',
        $str => ':attribute은(는) :max개보다 많을 수 없습니다.',
    ],
    'mimes'                => ':attribute은(는) 다음의 파일 형식이어야 합니다: :values.',
    'mimetypes'            => ':attribute은(는) 다음의 파일 형식이어야 합니다: :values.',
    'min'                  => [
        $str1 => ':attribute은(는) 최소한 :min이어야 합니다.',
        'file'    => ':attribute은(는) 최소한 :min킬로바이트이어야 합니다.',
        $str2 => ':attribute은(는) 최소한 :min자이어야 합니다.',
        $str => ':attribute은(는) 최소한 :min개의 항목이 있어야 합니다.',
    ],
    'not_in'               => '선택된 :attribute이(가) 유효하지 않습니다.',
    'not_regex'            => ':attribute의 형식이 올바르지 않습니다.',
    $str1 => ':attribute은(는) 숫자여야 합니다.',
    ...
    'size'                 => [
        $str1 => ':attribute은(는) :size (이)여야 합니다.',
        'file'    => ':attribute은(는) :size킬로바이트여야 합니다.',
        $str2 => ':attribute은(는) :size자여야 합니다.',
        $str => ':attribute은(는) :size개의 항목을 포함해야 합니다.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':attribute은(는) 문자열이어야 합니다.',
