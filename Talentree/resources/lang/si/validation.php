...
$str1 = 'numeric';
$str2 = 'string';
$str3 = 'මෙම තෝරා ඇත :attribute අවලංගුයි.';
$str4 = 'මෙම :attribute ආකෘතිය අවලංගුයි.';
$str5 = 'මෙම :attribute ක්ෂේත්රයයි අවශ්යයි එය :values තිබිය යුතුය.';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    $str => 'මෙම :attribute අරාව විය යුතුය.',
    'before'               => 'මෙම :attribute පෙර දින විය යුතුය :date.',
    'before_or_equal'      => 'මෙම :attribute පෙර හෝ ඊට සමාන දිනයකි :date.',
    'between'              => [
        $str1 => 'මෙම :attribute අතර විය යුතුය :min සහ :max.',
        'file'    => 'මෙම :attribute අතර විය යුතුය :min සහ :max කිලෝ බයිට ගණන.',
        $str2 => 'මෙම :attribute අතර විය යුතුය :min සහ :max ප්රමාණය.',
        $str => 'මෙම :attribute අතර තිබිය යුතුය :min සහ :max අයිතම.',
    ],
    ...
    'gt'                   => [
        $str1 => 'මෙම :attribute වඩා විශාල විය යුතුය :value.',
        'file'    => 'මෙම :attribute වඩා විශාල විය යුතුය :value කිලෝ බයිට ගණන.',
        $str2 => 'මෙම :attribute වඩා විශාල විය යුතුය :value ප්රමාණය.',
        $str => 'මෙම :attribute වඩා වැඩි විය යුතුය :value අයිතම.',
    ],
    'gte'                  => [
        $str1 => 'මෙම :attribute වඩා වැඩි හෝ සමාන විය යුතුය :value.',
        'file'    => 'මෙම :attribute වඩා වැඩි හෝ සමාන විය යුතුයl :value කිලෝ බයිට ගණන.',
        $str2 => 'මෙම :attribute වඩා වැඩි හෝ සමාන විය යුතුය :value ප්රමාණය.',
        $str => 'මෙම :attribute තිබිය යුතු :value අයිතම හෝ ඊට වැඩි.',
    ],
    ...
    'lt'                   => [
        $str1 => 'මෙම :attribute වඩා අඩු විය යුතුය :value.',
        'file'    => 'මෙම :attribute වඩා අඩු විය යුතුය :value කිලෝ බයිට ගණන.',
        $str2 => 'මෙම :attribute වඩා අඩු විය යුතුය :value ප්රමාණය..',
        $str => 'මෙම :attribute වඩා අඩු විය යුතුය :value අයිතම.',
    ],
    'lte'                  => [
        $str1 => 'මෙම :attribute අඩු හෝ සමාන විය යුතුය :value.',
        'file'    => 'මෙම :attribute අඩු හෝ සමාන විය යුතුය :value කිලෝ බයිට ගණන..',
        $str2 => 'මෙම :attribute අඩු හෝ සමාන විය යුතුය :value ප්රමාණය..',
        $str => 'මෙම :attribute වඩා වැඩි නොවිය යුතුය :value අයිතම.',
    ],
    'max'                  => [
        $str1 => 'මෙම :attribute වඩා විශාල විය නොහැකිය :max.',
        'file'    => 'මෙම :attribute වඩා විශාල විය නොහැකිය :max කිලෝ බයිට ගණන..',
        $str2 => 'මෙම :attribute වඩා විශාල විය නොහැකිය :max ප්රමාණය..',
        $str => 'මෙම :attribute වඩා වැඩි නොවිය හැක :max අයිතම.',
    ],
    'mimes'                => 'මෙම :attribute වර්ගයේ ගොනුවක් විය යුතුය: :values.',
    'mimetypes'            => 'මෙම :attribute වර්ගයේ ගොනුවක් විය යුතුය: :values.',
    'min'                  => [
        $str1 => 'මෙම :attribute අවම වශයෙන් විය යුතුය :min.',
        'file'    => 'මෙම :attribute අවම වශයෙන් විය යුතුය :min කිලෝ බයිට ගණන..',
        $str2 => 'මෙම :attribute අවම වශයෙන් විය යුතුය :min ප්රමාණය..',
        $str => 'මෙම :attribute අවම වශයෙන් තිබිය යුතුය :min අයිතම.',
    ],
    'not_in'               => $str3,
    'not_regex'            => $str4,
    $str1 => 'මෙම :attribute අංකයක් විය යුතුය.',
    ...
    'size'                 => [
        $str1 => 'මෙම :attribute විය යුතුය :size.',
        'file'    => 'මෙම :attribute විය යුතුය :size කිලෝ බයිට ගණන..',
        $str2 => 'මෙම :attribute විය යුතුය :size ප්රමාණය..',
        $str => 'මෙම :attribute must contain :size අයිතම.',
    ],
    'starts_with'          => 'මෙම :attribute පහත සඳහන් එකක් සමඟ ආරම්භ කළ යුතුය: :values',
    $str2 => 'මෙම :attribute පේළියකි විය යුතුය.',
