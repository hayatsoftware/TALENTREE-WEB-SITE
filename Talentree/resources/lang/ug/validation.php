...
return [
    ...
    */
    ...
    $str => ':attribute چوقۇم بۇرۇن بۇلىشى كېرەك.',
    'before'               => ':attribute چوقۇم :date دىن بۇرۇن بۇلىشى كېرەك.',
    'before_or_equal'      => ':attribute چوقۇم :date غا تەڭ ياكى بۇرۇن بۇلىشى كېرەك.',
    'between'              => [
        $str1 => ':attribute چوقۇم :min - :max ئارلىقىدا بۇلىشى كېرەك.',
        'file'    => ':attribute چوقۇم :min - :max kb ئارلىقىدا بۇلىشى كېرەك.',
        $str2 => ':attribute چوقۇم  :min - :max خەت ئارلىقىدا بۇلىشى كېرەك.',
        $str => ':attribute چوقۇم  :min - :max بۆلەك ئارلىقىدا بۇلىشى كېرەك.',
    ],
    ...
    'max'                  => [
        $str1 => ':attribute :max دىن چوڭ بولماسلىكى كېرەك.',
        'file'    => ':attribute :max kb دىن چوڭ بولماسلىكى كېرەك.',
        $str2 => ':attribute چوڭ-كىچىكلىكى :max خەتتىن ئېشىپ كەتمەسلىكى كېرەك.',
        $str => ':attribute ئەڭ كۆپ بولغاندا :max بۆلەك',
    ],
    ...
    'min'                  => [
        $str1 => ':attribute چوقۇم :min تەڭ ياكى چوڭ بۇلىشى كېرەك.',
        'file'    => ':attribute چوڭ-كىچىكلىكى چوقۇم :min kb دىن كىچىك بولماسلىقى كېرەك.',
        $str2 => ':attribute ئەڭ ئاز بولغاندا :min خەت بۇلىشى كېرەك.',
        $str => ':attribute ئەڭ ئاز بولغاندا :min بۆلەك بۇلىشى كېرەك.',
    ],
    'not_in'               => 'تاللانغان قىممەت :attribute ئىناۋەتسىز.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':attribute چوقۇم سان-سىفىر بۇلىشى كېرەك.',
    ...
    'size'                 => [
        $str1 => ':attribute چوڭ-كىچىكلىكى چوقۇم :size بۇلىشى كېرەك.',
        'file'    => ':attribute چوڭ-كىچىكلىكى چوقۇم :size kb بۇلىشى كېرەك.',
        $str2 => ':attribute چوقۇم :size خەت.',
        $str => ':attribute چوقۇم :size بۆلەك.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':attribute چوقۇم بىر ھەرىپ بەلگە تىزىقى بۇلىشى كېرەك.',
