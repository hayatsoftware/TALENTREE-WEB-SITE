...
return [
    ...
    */
    ...
    $str => ':attribute একটি অ্যারে হতে হবে।',
    ...
    'between'              => [
        $str1 => ':min এবং :max :attribute মধ্যে হতে হবে।',
        'file'    => ':min এবং :max কিলোবাইট :attribute মধ্যে হতে হবে।',
        $str2 => ':min এবং :max অক্ষর :attribute মধ্যে হতে হবে।',
        $str => ':min এবং :max আইটেম :attribute মধ্যে হতে হবে।',
    ],
    ...
    'max'                  => [
        $str1 => ' :attribute এর মান :max এর চেয়ে বড় হতে পারেনা।',
        'file'    => ':attribute এর মান :max কিলোবাইট এর চেয়ে বড় হতে পারেনা।',
        $str2 => ':attribute এর মান :max অক্ষর এর চেয়ে বড় হতে পারেনা।',
        $str => ':attribute এর মান :max টি উপাদানের চেয়ে বড় হতে পারেনা।',
    ],
    'mimes'                => ':attribute এর একটি ফাইল হতে হবে: :values।',
    'mimetypes'            => ':attribute এর একটি ফাইল হতে হবে: :values।',
    'min'                  => [
        $str1 => ':attribute অবশ্যই :min এর চেয়ে ছোট হতে হবে।',
        'file'    => ':attribute অবশ্যই :min কিলোবাইট এর চেয়ে ছোট হতে হবে।',
        $str2 => ':attribute অবশ্যই :min অক্ষর এর চেয়ে ছোট হতে হবে।',
        $str => ':attribute অবশ্যই :min উপাদানের চেয়ে ছোট হতে হবে।',
    ],
    'not_in'               => 'নির্বাচিত :attribute অবৈধ।',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':attribute একটি সংখ্যা হতে হবে।',
    ...
    'size'                 => [
        $str1 => ':attribute অবশ্যই :size হতে হবে।',
        'file'    => ':attribute অবশ্যই :size কিলোবাইট হতে হবে।',
        $str2 => ':attribute অবশ্যই :size অক্ষর হতে হবে।',
        $str => ':attribute অবশ্যই :size আইটেম হতে হবে।',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':attribute একটি স্ট্রিং হতে হবে।',
