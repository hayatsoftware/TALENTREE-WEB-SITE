...
return [
    ...
    */
    ...
    $str => ":attribute depet èssere un'array.",
    'before'               => ':attribute depet èssere una data chi benit prima de :date.',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => ':attribute depet èssere intre :min - :max.',
        'file'    => ':attribute depet èssere intre :min - :max kilobytes.',
        $str2 => ':attribute depet èssere intre :min - :max caràteres.',
        $str => ':attribute depet èssere intre :min - :max elementos.',
    ],
    ...
    'max'                  => [
        $str1 => ':attribute depet èssere prus piticu de :max.',
        'file'    => ':attribute non depet èssere prus mannu de :max kilobytes.',
        $str2 => ':attribute non podet cuntènnere prus de :max caràteres.',
        $str => ':attribute non podet tènnere prus de :max elementos.',
    ],
    'mimes'                => ':attribute depet èssere de tipu: :values.',
    'mimetypes'            => ':attribute depet èssere de tipu: :values.',
    'min'                  => [
        $str1 => ':attribute depet bàlere a su mancu :min.',
        'file'    => ':attribute depet èssere prus mannu de :min kilobytes.',
        $str2 => ':attribute depet cuntènnere a su mancu :min caràteres.',
        $str => ':attribute depet tènnere a su mancu :min elementos.',
    ],
    'not_in'               => 'Su balore seberadu pro :attribute no est bàlidu.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':attribute depet èssere unu nùmeru.',
    ...
    'size'                 => [
        $str1 => ':attribute depet bàlere :size.',
        'file'    => ':attribute depet èssere mannu :size kilobytes.',
        $str2 => ':attribute depet cuntènnere :size caràteres.',
        $str => ':attribute depet cuntènnere :size elementos.',
    ],
