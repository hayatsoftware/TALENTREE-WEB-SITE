...
return [
    ...
    */
    ...
    'between'              => [
        $str1 => 'Polje :attribute mora biti izmedju :min - :max.',
        'file'    => 'Fajl :attribute mora biti izmedju :min - :max kilobajta.',
        $str2 => 'Polje :attribute mora biti izmedju :min - :max karaktera.',
        $str => 'Polje :attribute mora biti između :min - :max karaktera.',
    ],
    ...
    'max'                  => [
        ...
        $str => 'Polje :attribute mora sadržati manje od :max karaktera.',
    ],
    ...
    'min'                  => [
        ...
        $str => 'Polje :attribute mora sadržati najmanje :min karaktera.',
    ],
    ...
    'size'                 => [
        ...
        $str => 'Polje :attribute mora biti :size karaktera.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'Polje :attribute mora sadrzavati slova.',
