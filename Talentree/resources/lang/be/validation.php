...
return [
    ...
    */
    ...
    $str => 'Поле :attribute павінна быць масівам.',
    'before'               => 'У полі :attribute павінна быць дата да :date.',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str1 => 'Поле :attribute павінна быць паміж :min і :max.',
        'file'    => 'Памер файла ў поле :attribute павінен быць паміж :min і :max кілабайт.',
        $str2 => 'Колькасць сiмвалаў у поле :attribute павінна быць паміж :min і :max.',
        $str => 'Колькасць элементаў у поле :attribute павінна быць паміж :min і :max.',
    ],
    ...
    'max'                  => [
        $str1 => 'Поле :attribute не можа быць больш :max.',
        'file'    => 'Памер файла ў поле :attribute не можа быць больш :max кілабайт).',
        $str2 => 'Колькасць сiмвалаў у поле :attribute не можа перавышаць :max.',
        $str => 'Колькасць элементаў у поле :attribute не можа перавышаць :max.',
    ],
    ...
    'min'                  => [
        $str1 => 'Поле :attribute павінна быць не менш :min.',
        'file'    => 'Памер файла ў полее :attribute павінен быць не менш :min кілабайт.',
        $str2 => 'Колькасць сiмвалаў у поле :attribute павінна быць не менш :min.',
        $str => 'Колькасць элементаў у поле :attribute павінна быць не менш :min.',
    ],
    'not_in'               => 'Выбранае значэнне для :attribute памылкова.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => 'Поле :attribute павінна быць лікам.',
    ...
    'size'                 => [
        $str1 => 'Поле :attribute павінна быць :size.',
        'file'    => 'Размер файла в поле :attribute павінен быць :size кілабайт.',
        $str2 => 'Колькасць сiмвалаў у поле :attribute павінна быць :size.',
        $str => 'Колькасць элементаў у поле :attribute павінна быць :size.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'Поле :attribute павінна быць радком.',
