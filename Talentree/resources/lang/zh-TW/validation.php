...
$str1 = 'numeric';
$str2 = 'string';
$str3 = '所選擇的 :attribute 選項無效。';
$str4 = ':attribute 的格式錯誤。';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'between'              => [
        $str1 => ':attribute 必須介於 :min 至 :max 之間。',
        'file'    => ':attribute 必須介於 :min 至 :max KB 之間。 ',
        $str2 => ':attribute 必須介於 :min 至 :max 個字元之間。',
        $str => ':attribute: 必須有 :min - :max 個元素。',
    ],
    ...
    'gt'                   => [
        ...
        $str2 => ':attribute 必須多於 :value 個字元。',
        $str => ':attribute 必須多於 :value 個元素。',
    ],
    'gte'                  => [
        $str1 => ':attribute 必須大於或等於 :value。',
        'file'    => ':attribute 必須大於或等於 :value KB。',
        $str2 => ':attribute 必須多於或等於 :value 個字元。',
        $str => ':attribute 必須多於或等於 :value 個元素。',
    ],
    ...
    'lt'                   => [
        ...
        $str2 => ':attribute 必須少於 :value 個字元。',
        $str => ':attribute 必須少於 :value 個元素。',
    ],
    'lte'                  => [
        $str1 => ':attribute 必須小於或等於 :value。',
        'file'    => ':attribute 必須小於或等於 :value KB。',
        $str2 => ':attribute 必須少於或等於 :value 個字元。',
        $str => ':attribute 必須少於或等於 :value 個元素。',
    ],
    'max'                  => [
        $str1 => ':attribute 不能大於 :max。',
        'file'    => ':attribute 不能大於 :max KB。',
        $str2 => ':attribute 不能多於 :max 個字元。',
        $str => ':attribute 最多有 :max 個元素。',
    ],
    ...
    'min'                  => [
        ...
        $str2 => ':attribute 不能小於 :min 個字元。',
        $str => ':attribute 至少有 :min 個元素。',
    ],
    'not_in'               => $str3,
    'not_regex'            => $str4,
    ...
    'size'                 => [
        ...
        $str2 => ':attribute 必須是 :size 個字元。',
        $str => ':attribute 必須是 :size 個元素。',
    ],
    'starts_with'          => ':attribute 必須以 :values 其中之一開頭。',
    $str2 => ':attribute 必須是一個字串。',
