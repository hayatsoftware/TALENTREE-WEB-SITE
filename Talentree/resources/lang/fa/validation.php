...
$str1 = 'numeric';
$str2 = 'string';
$str3 = ':attribute انتخاب شده، معتبر نیست.';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    $str => ':attribute باید آرایه باشد.',
    'before'               => ':attribute باید تاریخی قبل از :date باشد.',
    'before_or_equal'      => ':attribute باید تاریخی قبل از :date، یا مطابق با آن باشد.',
    'between'              => [
        $str1 => ':attribute باید بین :min و :max باشد.',
        'file'    => ':attribute باید بین :min و :max کیلوبایت باشد.',
        $str2 => ':attribute باید بین :min و :max کاراکتر باشد.',
        $str => ':attribute باید بین :min و :max آیتم باشد.',
    ],
    ...
    'gt'                   => [
        $str1 => ':attribute باید بزرگتر از :value باشد.',
        'file'    => ':attribute باید بزرگتر از :value کیلوبایت باشد.',
        $str2 => ':attribute باید بیشتر از :value کاراکتر داشته باشد.',
        $str => ':attribute باید بیشتر از :value آیتم داشته باشد.',
    ],
    'gte'                  => [
        $str1 => ':attribute باید بزرگتر یا مساوی :value باشد.',
        'file'    => ':attribute باید بزرگتر یا مساوی :value کیلوبایت باشد.',
        $str2 => ':attribute باید بیشتر یا مساوی :value کاراکتر داشته باشد.',
        $str => ':attribute باید بیشتر یا مساوی :value آیتم داشته باشد.',
    ],
    ...
    'lt'                   => [
        $str1 => ':attribute باید کوچکتر از :value باشد.',
        'file'    => ':attribute باید کوچکتر از :value کیلوبایت باشد.',
        $str2 => ':attribute باید کمتر از :value کاراکتر داشته باشد.',
        $str => ':attribute باید کمتر از :value آیتم داشته باشد.',
    ],
    'lte'                  => [
        $str1 => ':attribute باید کوچکتر یا مساوی :value باشد.',
        'file'    => ':attribute باید کوچکتر یا مساوی :value کیلوبایت باشد.',
        $str2 => ':attribute باید کمتر یا مساوی :value کاراکتر داشته باشد.',
        $str => ':attribute باید کمتر یا مساوی :value آیتم داشته باشد.',
    ],
    'max'                  => [
        $str1 => ':attribute نباید بزرگتر از :max باشد.',
        'file'    => ':attribute نباید بزرگتر از :max کیلوبایت باشد.',
        $str2 => ':attribute نباید بیشتر از :max کاراکتر داشته باشد.',
        $str => ':attribute نباید بیشتر از :max آیتم داشته باشد.',
    ],
    'mimes'                => 'فرمت‌های معتبر فایل عبارتند از: :values.',
    'mimetypes'            => 'فرمت‌های معتبر فایل عبارتند از: :values.',
    'min'                  => [
        $str1 => ':attribute نباید کوچکتر از :min باشد.',
        'file'    => ':attribute نباید کوچکتر از :min کیلوبایت باشد.',
        $str2 => ':attribute نباید کمتر از :min کاراکتر داشته باشد.',
        $str => ':attribute نباید کمتر از :min آیتم داشته باشد.',
    ],
    'not_in'               => $str3,
    'not_regex'            => 'فرمت :attribute معتبر نیست.',
    $str1 => ':attribute باید عدد یا رشته‌ای از اعداد باشد.',
    ...
    'size'                 => [
        $str1 => ':attribute باید برابر با :size باشد.',
        'file'    => ':attribute باید برابر با :size کیلوبایت باشد.',
        $str2 => ':attribute باید برابر با :size کاراکتر باشد.',
        $str => ':attribute باید شامل :size آیتم باشد.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'فیلد :attribute باید رشته باشد.',
