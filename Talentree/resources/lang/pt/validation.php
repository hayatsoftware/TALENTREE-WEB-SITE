...
return [
    ...
    */
    ...
    $str => 'O campo :attribute deverá conter uma coleção de elementos.',
    'before'               => 'O campo :attribute deverá conter uma data anterior a :date.',
    'before_or_equal'      => 'O Campo :attribute deverá conter uma data anterior ou igual a :date.',
    'between'              => [
        $str1 => 'O campo :attribute deverá ter um valor entre :min - :max.',
        'file'    => 'O campo :attribute deverá ter um tamanho entre :min - :max kilobytes.',
        $str2 => 'O campo :attribute deverá conter entre :min - :max caracteres.',
        $str => 'O campo :attribute deverá conter entre :min - :max elementos.',
    ],
    ...
    'max'                  => [
        $str1 => 'O campo :attribute não deverá conter um valor superior a :max.',
        'file'    => 'O campo :attribute não deverá ter um tamanho superior a :max kilobytes.',
        $str2 => 'O campo :attribute não deverá conter mais de :max caracteres.',
        $str => 'O campo :attribute não deverá conter mais de :max elementos.',
    ],
    'mimes'                => 'O campo :attribute deverá conter um ficheiro do tipo: :values.',
    'mimetypes'            => 'O campo :attribute deverá conter um ficheiro do tipo: :values.',
    'min'                  => [
        $str1 => 'O campo :attribute deverá ter um valor superior ou igual a :min.',
        'file'    => 'O campo :attribute deverá ter no mínimo :min kilobytes.',
        $str2 => 'O campo :attribute deverá conter no mínimo :min caracteres.',
        $str => 'O campo :attribute deverá conter no mínimo :min elementos.',
    ],
    'not_in'               => 'O campo :attribute contém um valor inválido.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => 'O campo :attribute deverá conter um valor numérico.',
    ...
    'size'                 => [
        $str1 => 'O campo :attribute deverá conter o valor :size.',
        'file'    => 'O campo :attribute deverá ter o tamanho de :size kilobytes.',
        $str2 => 'O campo :attribute deverá conter :size caracteres.',
        $str => 'O campo :attribute deverá conter :size elementos.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'O campo :attribute deverá conter texto.',
