...
return [
    ...
    */
    ...
    $str => ':Attribute талбар массив байх шаардлагатай.',
    ...
    'between'              => [
        $str1 => ':Attribute талбарт :min-:max хооронд тоо оруулна уу.',
        'file'    => ':Attribute талбарт :min-:max килобайт хэмжээтэй файл оруулна уу.',
        $str2 => ':Attribute талбарт :min-:max урттай текст оруулна уу.',
        $str => ':Attribute массивт :min-:max элемэнт байх шаардлагатай.',
    ],
    ...
    'max'                  => [
        $str1 => ':Attribute талбарт :max буюу түүнээс бага утга оруулна уу.',
        'file'    => ':Attribute талбарт :max килобайтаас бага хэмжээтэй файл оруулна уу.',
        $str2 => ':Attribute талбарт :max-с бага урттай текст оруулна уу.',
        $str => ':Attribute талбарт хамгийн ихдээ :max элемэнт оруулах боломжтой.',
    ],
    'mimes'                => ':Attribute талбарт дараах төрлийн файл оруулах боломжтой: :values.',
    'mimetypes'            => ':Attribute талбарт дараах төрлийн файл оруулах боломжтой: :values.',
    'min'                  => [
        $str1 => ':Attribute талбарт :min буюу түүнээс их тоо оруулна уу.',
        'file'    => ':Attribute талбарт :min килобайтаас их хэмжээтэй файл оруулна уу.',
        $str2 => ':Attribute талбарт :min буюу түүнээс их үсэг бүхий текст оруулна уу.',
        $str => ':Attribute талбарт хамгийн багадаа :min элемэнт оруулах боломжтой.',
    ],
    'not_in'               => 'Буруу :attribute сонгогдсон байна.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':Attribute талбарт тоон утга оруулна уу.',
    ...
    'size'                 => [
        $str1 => ':Attribute :size хэмжээтэй байх шаардлагатай.',
        'file'    => ':Attribute :size килобайт хэмжээтэй байх шаардлагатай.',
        $str2 => ':Attribute :size тэмдэгтийн урттай байх шаардлагатай.',
        $str => ':Attribute :size элемэнттэй байх шаардлагатай.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':Attribute талбарт текст оруулна уу.',
