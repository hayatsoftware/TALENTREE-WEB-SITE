...
return [
    ...
    */
    ...
    $str => ':Attribute майдони қатор (array) бўлиши керак.',
    ...
    'between'              => [
        $str1 => ':Attribute майдонининг қиймати :min ва :max орасида бўлиши керак.',
        'file'    => ':Attribute майдонидаги файлнинг ҳажми :min ва :max килобайт орасида бўлиши керак.',
        $str2 => ':Attribute майдонидаги белгилар сони :min ва :max орасида бўлиши керак.',
        $str => ':Attribute майдонида элементлар сони :min ва :max орасида бўлиши керак.',
    ],
    ...
    'max'                  => [
        $str1 => ':Attribute майдони қиймати :max дан ошмаслиги керак.',
        'file'    => ':Attribute майдонидаги файлнинг ҳажми :max килобайтдан ошмаслиги керак.',
        $str2 => ':Attribute майдонидаги белгилар сони :max тадан ошмаслиги керак.',
        $str => ':Attribute майдонидаги элментлар сони :max тадан ошмаслиги керак.',
    ],
    ...
    'min'                  => [
        $str1 => ':Attribute майдони қиймати :min дан кам бўлмаслиги керак.',
        'file'    => ':Attribute майдонидаги файлнинг ҳажми :min килобайтдан кам бўлмаслиги керак.',
        $str2 => ':Attribute майдонидаги белгилар сони :min тадан кам бўлмаслиги керак.',
        $str => ':Attribute майдонидаги элментлар сони :min тадан кам бўлмаслиги керак.',
    ],
    'not_in'               => ':Attribute майдони учун танланган қиймат хато.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => ':Attribute майдони сон бўлиши керак.',
    ...
    'size'                 => [
        $str1 => ':Attribute майдони қиймати :size га тенг бўлиши керак.',
        'file'    => ':Attribute майдонидаги файлнинг ҳажми :size килобайтга тенг бўлиши керак.',
        $str2 => ':Attribute майдонидаги белгилар сони :size га тенг бўлиши керак.',
        $str => ':Attribute майдонидаги элментлар сони :size га тенг бўлиши керак.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => ':Attribute майдони қатор (string) бўлиши керак.',
