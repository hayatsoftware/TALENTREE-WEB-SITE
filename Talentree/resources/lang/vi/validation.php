...
$str2 = 'string';
$str3 = 'email';
$str4 = 'Giá trị đã chọn trong trường :attribute không hợp lệ.';
return [
    ...
    */
    ...
    $str => 'Trường :attribute phải là dạng mảng.',
    'before'               => 'Trường :attribute phải là một ngày trước ngày :date.',
    'before_or_equal'      => 'Trường :attribute phải là thời gian bắt đầu trước hoặc đúng bằng :date.',
    'between'              => [
        $str1 => 'Trường :attribute phải nằm trong khoảng :min - :max.',
        'file'    => 'Dung lượng tập tin trong trường :attribute phải từ :min - :max kB.',
        $str2 => 'Trường :attribute phải từ :min - :max ký tự.',
        $str => 'Trường :attribute phải có từ :min - :max phần tử.',
    ],
    ...
    $str3 => 'Trường :attribute phải là một địa chỉ email hợp lệ.',
    'exists'               => $str4,
    'file'                 => 'Trường :attribute phải là một tệp tin.',
    'filled'               => 'Trường :attribute không được bỏ trống.',
    'gt'                   => [
        $str1 => 'Giá trị trường :attribute phải lớn hơn :value.',
        'file'    => 'Dung lượng trường :attribute phải lớn hơn :value kilobytes.',
        $str2 => 'Độ dài trường :attribute phải nhiều hơn :value kí tự.',
        $str => 'Mảng :attribute phải có nhiều hơn :value phần tử.',
    ],
    'gte'                  => [
        $str1 => 'Giá trị trường :attribute phải lớn hơn hoặc bằng :value.',
        'file'    => 'Dung lượng trường :attribute phải lớn hơn hoặc bằng :value kilobytes.',
        $str2 => 'Độ dài trường :attribute phải lớn hơn hoặc bằng :value kí tự.',
        $str => 'Mảng :attribute phải có ít nhất :value phần tử.',
    ],
    ...
    'lt'                   => [
        $str1 => 'Giá trị trường :attribute phải nhỏ hơn :value.',
        'file'    => 'Dung lượng trường :attribute phải nhỏ hơn :value kilobytes.',
        $str2 => 'Độ dài trường :attribute phải nhỏ hơn :value kí tự.',
        $str => 'Mảng :attribute phải có ít hơn :value phần tử.',
    ],
    'lte'                  => [
        $str1 => 'Giá trị trường :attribute phải nhỏ hơn hoặc bằng :value.',
        'file'    => 'Dung lượng trường :attribute phải nhỏ hơn hoặc bằng :value kilobytes.',
        $str2 => 'Độ dài trường :attribute phải nhỏ hơn hoặc bằng :value kí tự.',
        $str => 'Mảng :attribute không được có nhiều hơn :value phần tử.',
    ],
    'max'                  => [
        $str1 => 'Trường :attribute không được lớn hơn :max.',
        'file'    => 'Dung lượng tập tin trong trường :attribute không được lớn hơn :max kB.',
        $str2 => 'Trường :attribute không được lớn hơn :max ký tự.',
        $str => 'Trường :attribute không được lớn hơn :max phần tử.',
    ],
    ...
    'min'                  => [
        $str1 => 'Trường :attribute phải tối thiểu là :min.',
        'file'    => 'Dung lượng tập tin trong trường :attribute phải tối thiểu :min kB.',
        $str2 => 'Trường :attribute phải có tối thiểu :min ký tự.',
        $str => 'Trường :attribute phải có tối thiểu :min phần tử.',
    ],
    'not_in'               => $str4,
    'not_regex'            => 'Trường :attribute có định dạng không hợp lệ.',
    $str1 => 'Trường :attribute phải là một số.',
    ...
    'size'                 => [
        $str1 => 'Trường :attribute phải bằng :size.',
        'file'    => 'Dung lượng tập tin trong trường :attribute phải bằng :size kB.',
        $str2 => 'Trường :attribute phải chứa :size ký tự.',
        $str => 'Trường :attribute phải chứa :size phần tử.',
    ],
    'starts_with'          => 'Trường :attribute phải được bắt đầu bằng một trong những giá trị sau: :values',
    $str2 => 'Trường :attribute phải là một chuỗi ký tự.',
