...
return [
    ...
    */
    ...
    $str => 'Полето :attribute мора да биде низа.',
    'before'               => 'Полето :attribute мора да биде датум пред :date.',
    'before_or_equal'      => 'The :attribute must be a date before or equal to :date.',
    'between'              => [
        $str2 => 'Полето :attribute мора да биде помеѓу :min и :max.',
        'file'    => 'Полето :attribute мора да биде помеѓу :min и :max килобајти.',
        $str1 => 'Полето :attribute мора да биде помеѓу :min и :max карактери.',
        $str => 'Полето :attribute мора да има помеѓу :min - :max карактери.',
    ],
    ...
    'max'                  => [
        $str2 => 'Полето :attribute мора да биде помало од :max.',
        'file'    => 'Полето :attribute мора да биде помало од :max килобајти.',
        $str1 => 'Полето :attribute мора да има помалку од :max карактери.',
        $str => 'Полето :attribute не може да има повеќе од :max карактери.',
    ],
    'mimes'                => 'Полето :attribute мора да биде фајл од типот: :values.',
    'mimetypes'            => 'Полето :attribute мора да биде фајл од типот: :values.',
    'min'                  => [
        $str2 => 'Полето :attribute мора да биде минимум :min.',
        'file'    => 'Полето :attribute мора да биде минимум :min килобајти.',
        $str1 => 'Полето :attribute мора да има минимум :min карактери.',
        $str => 'Полето :attribute мора да има минимум :min карактери.',
    ],
    'not_in'               => 'Избраното поле :attribute е невалидно.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str2 => 'Полето :attribute мора да биде број.',
    ...
    'size'                 => [
        $str2 => 'Полето :attribute мора да биде :size.',
        'file'    => 'Полето :attribute мора да биде :size килобајти.',
        $str1 => 'Полето :attribute мора да има :size карактери.',
        $str => 'Полето :attribute мора да има :size карактери.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str1 => 'The :attribute must be a string.',
