...
$str1 = 'numeric';
$str2 = 'string';
$str3 = 'Полето :attribute е в невалиден формат.';
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    $str => 'Полето :attribute трябва да бъде масив.',
    'before'               => 'Полето :attribute трябва да бъде дата преди :date.',
    'before_or_equal'      => 'Полето :attribute трябва да бъде дата преди или равна на :date.',
    'between'              => [
        $str1 => 'Полето :attribute трябва да бъде между :min и :max.',
        'file'    => 'Полето :attribute трябва да бъде между :min и :max килобайта.',
        $str2 => 'Полето :attribute трябва да бъде между :min и :max знака.',
        $str => 'Полето :attribute трябва да има между :min - :max елемента.',
    ],
    ...
    'max'                  => [
        $str1 => 'Полето :attribute трябва да бъде по-малко от :max.',
        'file'    => 'Полето :attribute трябва да бъде по-малко от :max килобайта.',
        $str2 => 'Полето :attribute трябва да бъде по-малко от :max знака.',
        $str => 'Полето :attribute трябва да има по-малко от :max елемента.',
    ],
    'mimes'                => 'Полето :attribute трябва да бъде файл от тип: :values.',
    'mimetypes'            => 'Полето :attribute трябва да бъде файл от тип: :values.',
    'min'                  => [
        $str1 => 'Полето :attribute трябва да бъде минимум :min.',
        'file'    => 'Полето :attribute трябва да бъде минимум :min килобайта.',
        $str2 => 'Полето :attribute трябва да бъде минимум :min знака.',
        $str => 'Полето :attribute трябва има минимум :min елемента.',
    ],
    'not_in'               => 'Избраното поле :attribute е невалидно.',
    'not_regex'            => 'The :attribute format is invalid.',
    $str1 => 'Полето :attribute трябва да бъде число.',
    ...
    'size'                 => [
        $str1 => 'Полето :attribute трябва да бъде :size.',
        'file'    => 'Полето :attribute трябва да бъде :size килобайта.',
        $str2 => 'Полето :attribute трябва да бъде :size знака.',
        $str => 'Полето :attribute трябва да има :size елемента.',
    ],
    'starts_with'          => 'The :attribute must start with one of the following: :values',
    $str2 => 'Полето :attribute трябва да бъде знаков низ.',
